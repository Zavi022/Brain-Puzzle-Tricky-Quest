...
public class GameData
{
	public GameData()
	{
		// Ensure collections are initialized even if resetData hasn't been called yet
		itemPicked = new List<GameObject>();
	}

	static GameData()
	{
		// Ensure static instance is available as soon as the class is referenced
	...
	public static int totalLevel = 20;//total levels
	public int[] tipUsed = new int[totalLevel];
	...
	public List<GameObject> itemPicked;//store the list of items in each level;
