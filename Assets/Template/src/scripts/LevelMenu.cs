...
public class LevelMenu : MonoBehaviour {
	...
	void Start()
	{
		...
		GameManager.instance.playMusic("bgmusic");
	}
	...
	public void swipePage(float force){
		...
		GameObject.Find("header").transform.Find("title").GetComponent<Text>().text = Localization.Instance.GetString("levelTitle");
