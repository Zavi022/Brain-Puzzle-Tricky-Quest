...
public class PanelBuyCoin : MonoBehaviour {
        ...
        Transform adsRow = panel.transform.Find("watchAdsRow");
        adsRow.Find("lbDetail").GetComponent<Text>().text = Localization.Instance.GetString("watchAdsDetail");
        adsRow.Find("lbPrice").GetComponent<Text>().text = Localization.Instance.GetString("watchAdsPrice");
    ...
    IEnumerator hideWait(){
		...
		public void OnClick2(GameObject g){
            ...
            case "btnClose":
                ...
                break;
            case "btnWatchAds":
				GameManager.getInstance().showGoogleRewardedAd();
                break;
        }
		}
